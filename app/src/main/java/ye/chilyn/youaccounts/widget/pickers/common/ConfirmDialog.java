...
import ye.chilyn.youaccounts.widget.pickers.util.ConvertUtils;
...
public abstract class ConfirmDialog<V extends View> extends BaseDialog<View> {
    ...
    public ConfirmDialog(Context context) {
        ...
        submitText = context.getString(android.R.string.ok);
    }
    ...
    protected final View makeContentView() {
        ...
        if (topLineVisible) {
            ...
            int height = ConvertUtils.toPx(context, topLineHeight);
    ...
    protected View makeHeaderView() {
        ...
        int height = ConvertUtils.toPx(context, topHeight);
        ...
        int padding = ConvertUtils.toPx(context, topPadding);
        ...
        if (null == titleView) {
            ...
            int margin = ConvertUtils.toPx(context, topPadding);
